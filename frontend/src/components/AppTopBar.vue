  ...
  <header class="app-topbar">
    <div class="topbar-inner">
      ...
      <div class="topbar-right">
        <a class="topbar-btn" href="https://maple0517.github.io/reader-next/" target="_blank" title="文档" rel="noopener noreferrer">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" />
    </svg>
  </a>
  <a class="topbar-btn" href="https://github.com/Maple0517/reader-next" target="_blank" title="GitHub" rel="noopener noreferrer">
